        ...
        $("#saveRemark").click(function () {
            $.ajax({
                ...
                data: {
                    ...
                    createBy:"${requestScope.a.owner}",//也可以在控制器生成
        ...
        $("#updateRemarkBtn").click(function () {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if(data.success){
                        //修改备注成功
                        //修改div中相应的信息，需要更新的内容noteContent，editTime，editBy
                        $("#e"+id).html(data.ar.noteContent);
                        var a=data.ar.editTime+" 由"+data.ar.editBy
                        $("#s"+id).html(a);
		...
		$.ajax({
			...
			success: function (data) {
				...
				$.each(data,function (i,n) {
					...
					//图标是bootstrap提供的可以取官网查看<span class="glyphicon glyphicon-edit" style="font-size: 20px; color: #FF0000;"></span>就是图标的样式
					html +='&nbsp;&nbsp;&nbsp;&nbsp;';
