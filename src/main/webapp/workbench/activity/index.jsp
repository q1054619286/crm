...
<script type="text/javascript">
	...
	$(function(){
        ...
        $("#addBtn").click(function () {
            ...
            /*
                操作模态窗口得方式，
                需要操作得模态窗口得jquery对象，调用modal方法，为该方法传递参数 show:打开模态窗口  hide:关闭模态窗口
			...
			$.ajax({
				...
				success: function (data) {
					...
					//遍历出来得每一个n,就是每一个user对象
					$.each(data,function (i,n) {
						html+="<option value='"+n.id+"'>"+n.name+"</option>"
					})
					$("#create-owner").html(html);

					//将当前登录得用户，设置为下拉框默认得选项
					/*
						...
						*/
						...
						/*
							注意；
								...
								都是表单的jquery对象，没有为我们提供reset()方法让我们重置表单（坑，idea为我们提示了有reset()方法）

								虽然jquery对象没有为我们提供reset方法，都是原生js为我们提供了reset方法
	...
	/*
		...
		以上pageList方法制定了六个入口，也就是说，以上6个操作执行完毕后，我们必须调用pageList方法，刷新市场活动信息列表
	 */
								...
								<!--
									关于文本域textarea
										...
										(2)textarea虽然是以标签对的形式来呈现的，但是它也是属于表单元素范畴
											我们所有的对于textarea的取值和赋值操作们应该统一使用val()方法（而不是html()方法）
								-->
			...
			<div class="btn-toolbar" role="toolbar" style="background-color: #F7F7F7; height: 50px; position: relative;top: 5px;">
				<div class="btn-group" style="position: relative; top: 18%;">
                    <!--
                        ...
                        现在我们时以属性和数学值得方式写在了button元素中，用来打开模态窗口
                        都是这样做是有问题得。
                            问题在于没有办法对按钮得功能进行扩充

                        所以未来得实际项目开发，对于触发模态窗口得操作，一定不要写死再元素当中，
                        应该由我们自己写js代码来操作
