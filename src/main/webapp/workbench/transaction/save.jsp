...
<body>
	...
	<form action="workbench/transaction/save.do" method="post" id="tranForm" class="form-horizontal" role="form" style="position: relative; top: -30px;">
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="text" class="form-control" id="create-activitySrc" value="发传单1" readonly>
				<input type="hidden" value="c15a86b90481419d98f19d20df86a0d1" name="activityId">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="text" class="form-control" id="create-contactsName" value="马云" readonly>
				<input type="hidden" value="c8dbaabea7b1426f9bead257ab2b67d5" name="contactsId">
			</div>
		</div>
